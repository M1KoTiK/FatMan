...
public partial class PlayerBody : CharacterBody2D
{
	...
	[Export] public float jumpReleaseMultiplier = 0.75f;
...
//			var dotProduct = normal.Dot(velocity);
...
//		}
		...
		if (IsJumping && Input.IsActionJustReleased("ui_accept")) 
		{
			verticalVelocity *= jumpReleaseMultiplier;
		}
